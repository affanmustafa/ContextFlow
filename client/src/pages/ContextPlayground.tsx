                        ...
                        <div className="min-h-screen bg-[#f8fafc] p-8 font-sans text-slate-900">
                                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-8">
                                        ...
                                        <div className="lg:col-span-6">
                                                <div className="bg-white rounded-3xl shadow-lg border border-slate-100 h-[calc(100vh-200px)] flex flex-col overflow-hidden relative">
                                                        {/* Window Header */}
                                                        ...
                                                        {/* Scrollable Area */}
                                                        <div className="flex-1 p-6 bg-[url('https://www.transparenttextures.com/patterns/cubes.png')] bg-fixed relative overflow-y-auto">
                                                                <SortableContext
                                                                        items={messages}
